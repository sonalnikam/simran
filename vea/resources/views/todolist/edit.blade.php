...
<div class="card">
                            ...
                            <div class="card-block">
                                    <div class="form-group">
                                        ...
                                        <input name ="name" type="text" class="form-control" id="name" placeholder="Name" value="{{ $todolist->name }}">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name ="date_assigned" type="date" class="form-control" id="date_assigned"  placeholder="Date Assigned" value="{{ $todolist->dateassigned }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name ="task" class="form-control" id="task" placeholder="Task">{{$todolist->task}}</textarea>
